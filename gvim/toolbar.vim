"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" HarnoRanaivo's .gvim/toolbar.vim file
...
if !exists("did_install_custom_toolbar")
    ...
    "" Buttons and icons {{{
    amenu icon=~/.gvim/bitmaps/16/document-new.png 1.10 ToolBar.New :new<CR>
    amenu icon=~/.gvim/bitmaps/16/document-open.png 1.20 ToolBar.Open :browse confirm e<CR>
    ...
    an icon=~/.gvim/bitmaps/16/edit-undo.png 1.50 ToolBar.Undo u
    an icon=~/.gvim/bitmaps/16/edit-redo.png 1.60 ToolBar.Redo <C-R>
    ...
    an icon=~/.gvim/bitmaps/16/system-run.png 1.100 ToolBar.Make :make<CR>
    " an icon=~/.gvim/bitmaps/16/gtk-select-all.png 1.110 ToolBar.RunCtags :exe "!" . g:ctags_command<CR>
    " an icon=~/.gvim/bitmaps/16/go-jump.png 1.120 ToolBar.TagJump g<C-]>
    ...
    an icon=~/.gvim/bitmaps/16/window_fullscreen.png 1.310 ToolBar.Maximize <C-w>_
    an icon=~/.gvim/bitmaps/16/zoom-fit-best.png 1.320 ToolBar.ResizeEqual <C-w>=
